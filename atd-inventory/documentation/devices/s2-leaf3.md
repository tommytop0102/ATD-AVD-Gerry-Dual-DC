...
| --------- | --------------- | ------------ | --------- |
| pod22 | Vlan4094 | 10.222.252.9 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet4 | routed | - | 172.32.255.17/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet4 | routed | - | 172.32.255.19/31 | default | 1500 | False | - | - |
...
| Loopback100 | bluevrf_VTEP_DIAGNOSTICS | bluevrf | 10.255.1.7/32 |
...
| Vlan3009 |  bluevrf  |  10.222.251.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.222.251.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.222.252.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.222.251.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.32.255.16 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.32.255.18 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.222.251.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | bluevrf | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.2.255.7:20110 | 20110:20110 | - | - | learned |
| 160 | 192.2.255.7:55160 | 55160:55160 | - | - | learned |
| 360 | 192.2.255.7:55360 | 55360:55360 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| bluevrf | 192.2.255.7:10 | connected |
...
router bgp 65202
   ...
   neighbor 10.222.251.9 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.222.251.9 description s2-leaf4
   neighbor 172.32.255.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.16 remote-as 65002
   neighbor 172.32.255.16 description s2-spine1_Ethernet4
   neighbor 172.32.255.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.18 remote-as 65002
   neighbor 172.32.255.18 description s2-spine2_Ethernet4
...
```eos
!
ip address virtual source-nat vrf bluevrf address 10.255.1.7
```
