...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | default | 192.168.0.124/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| pod22 | Vlan4094 | 10.222.252.105 | Port-Channel1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet4 | - | 172.32.255.209/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet4 | - | 172.32.255.211/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.2.255.55/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.2.254.55/32 |
| Loopback100 | DIAG_VRF_bluevrf | bluevrf | 10.255.1.55/32 |
...
| Vlan3009 |  bluevrf  |  10.222.251.104/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.222.251.104/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.222.252.104/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.222.251.105 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.32.255.208 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.32.255.210 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.222.251.105 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | bluevrf | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 192.2.255.55:30020 | 30020:30020 | - | - | learned |
| 2300 | 192.2.255.55:32300 | 32300:32300 | - | - | learned |
| 2301 | 192.2.255.55:32301 | 32301:32301 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| bluevrf | 192.2.255.55:10 | connected |
...
router bgp 65202
   ...
   neighbor 10.222.251.105 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.222.251.105 description s2-leaf4_Vlan4093
   neighbor 172.32.255.208 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.208 remote-as 65002
   neighbor 172.32.255.208 description s2-spine1_Ethernet4
   neighbor 172.32.255.210 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.210 remote-as 65002
   neighbor 172.32.255.210 description s2-spine2_Ethernet4
   ...
   vrf bluevrf
      ...
      router-id 192.2.255.55
      neighbor 10.222.251.105 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.222.251.105 description s2-leaf4_Vlan3009
...
ip prefix-list PL-MLAG-PEER-VRFS
   seq 10 permit 10.222.251.104/31
```
...
```eos
!
ip address virtual source-nat vrf bluevrf address 10.255.1.55
```
