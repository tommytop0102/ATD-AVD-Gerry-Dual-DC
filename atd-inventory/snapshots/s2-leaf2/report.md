...
Et1                            up             up                 MLAG_PEER_s2-leaf1_Ethernet1
Et2                            up             up                 P2P_LINK_TO_S2-SPINE1_Ethernet3
Et3                            up             up                 P2P_LINK_TO_S2-SPINE2_Ethernet3
Et4                            up             up                 s2-host1_NIC2
Et6                            up             up                 MLAG_PEER_s2-leaf1_Ethernet6
Lo0                            up             up                 EVPN_Overlay_Peering
Lo1                            up             up                 VTEP_VXLAN_Tunnel_Source
Lo100                          up             up                 bluevrf_VTEP_DIAGNOSTICS
Ma0                            up             up                 
Po1                            up             up                 MLAG_PEER_s2-leaf1_Po1
Po4                            down           lowerlayerdown     s2-host1_PortChannel
Vl1199                         up             up                 
...
--------------- --------------------- ---------- ------------ --------- -------
Ethernet2       172.32.255.205/31     up         up              1500          
Ethernet3       172.32.255.207/31     up         up              1500          
Loopback0       192.2.255.54/32       up         up             65535          
Loopback1       192.2.254.53/32       up         up             65535          
Loopback100     10.255.1.54/32        up         up             65535          
Management0     192.168.0.123/24      up         up              1500          
Vlan1199        unassigned            up         up              9164          
Vlan2300        192.168.11.1/24       up         up              1500          
Vlan2301        192.168.12.1/24       up         up              1500          
Vlan3009        10.222.251.101/31     up         up              1500          
Vlan4093        10.222.251.101/31     up         up              1500          
Vlan4094        10.222.252.101/31     up         up              1500
```
## show lldp neighbors

```
Last table change time   : 6:23:40 ago
...
---------- ------------------------ ---------------------- ---
Et1           s2-leaf1.atd.lab         Ethernet1           120
Et2           s2-spine1.atd.lab        Ethernet3           120
Et3           s2-spine2.atd.lab        Ethernet3           120
Et4           s2-host1.atd.lab         Ethernet2           120
Et6           s2-leaf1.atd.lab         Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: s2-leaf2 (cEOSLab, EOS-4.33.0F-39050855.4330F (engineering build))
!
no aaa root
!
...
Arista cEOSLab
Hardware version: 
Serial number: s2-leaf2
Hardware MAC address: 001c.73c0.c623
System MAC address: 001c.73c0.c623
