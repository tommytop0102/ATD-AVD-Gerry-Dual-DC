...
Et1                            up             up                 
Et2                            down           down               
Et3                            up             up                 P2P_LINK_TO_s1-brdr2_Ethernet5
Et4                            up             up                 
Et6                            up             up                 
...
--------------- -------------------- ---------- ------------ ---------- -------
Ethernet3       172.16.30.3/31       up         up              9194           
Ethernet4       30.2.2.1/24          up         up              1500           
Loopback0       192.168.250.2/32     up         up             65535           
Management0     192.168.0.103/24     up         up              1500
```
## show lldp neighbors
...
---------- ------------------------ ---------------------- ---
Et1           s1-core1.atd.lab         Ethernet1           120
Et3           s1-brdr2.atd.lab         Ethernet5           120
Et4           s2-core2.atd.lab         Ethernet4           120
Et6           s1-core1.atd.lab         Ethernet6           120
```
## show running-config
...
Arista cEOSLab
Hardware version: 
Serial number: s1-core2
Hardware MAC address: 001c.73c0.c103
System MAC address: 001c.73c0.c103
