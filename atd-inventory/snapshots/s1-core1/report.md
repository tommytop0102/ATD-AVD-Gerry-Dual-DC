...
Et1                            up             up                 
Et2                            up             up                 P2P_LINK_TO_s1-brdr1_Ethernet4
Et3                            down           down               
Et4                            up             up                 TO DC2 s2-core1 eth4
Et6                            up             up                 
...
--------------- -------------------- ---------- ------------ ---------- -------
Ethernet2       172.16.30.1/31       up         up              9194           
Ethernet4       30.1.1.1/24          up         up              1500           
Loopback0       192.168.250.1/32     up         up             65535           
Management0     192.168.0.102/24     up         up              1500
```
## show lldp neighbors

```
Last table change time   : 6:22:05 ago
...
---------- ------------------------ ---------------------- ---
Et1           s1-core2.atd.lab         Ethernet1           120
Et2           s1-brdr1.atd.lab         Ethernet4           120
Et4           s2-core1.atd.lab         Ethernet4           120
Et6           s1-core2.atd.lab         Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: s1-core1 (cEOSLab, EOS-4.33.0F-39050855.4330F (engineering build))
!
no aaa root
!
...
Arista cEOSLab
Hardware version: 
Serial number: s1-core1
Hardware MAC address: 001c.73c0.c102
System MAC address: 001c.73c0.c102
