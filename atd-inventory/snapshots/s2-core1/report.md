...
--------------- -------------------- ---------- ------------ ---------- -------
Ethernet2       172.16.30.5/31       up         up              9194           
Ethernet4       30.1.1.2/24          up         up              1500           
Loopback0       192.168.250.3/32     up         up             65535           
Management0     192.168.0.202/24     up         up              1500
```
## show lldp neighbors
...
---------- ------------------------ ---------------------- ---
Et1           s2-core2.atd.lab         Ethernet1           120
Et2           s2-brdr1.atd.lab         Ethernet4           120
Et4           s1-core1.atd.lab         Ethernet4           120
Et6           s2-core2.atd.lab         Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: s2-core1 (cEOSLab, EOS-4.33.0F-39050855.4330F (engineering build))
!
no aaa root
!
...
Arista cEOSLab
Hardware version: 
Serial number: s2-core1
Hardware MAC address: 001c.73c0.c202
System MAC address: 001c.73c0.c202
