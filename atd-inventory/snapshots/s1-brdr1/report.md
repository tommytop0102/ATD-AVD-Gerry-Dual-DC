...
Et1                            up             up                 MLAG_PEER_s1-brdr2_Ethernet1
Et2                            up             up                 P2P_LINK_TO_S1-SPINE1_Ethernet7
Et3                            up             up                 P2P_LINK_TO_S1-SPINE2_Ethernet7
Et4                            up             up                 P2P_LINK_TO_s1-core1_Ethernet2
Et5                            down           down               
Et6                            up             up                 MLAG_PEER_s1-brdr2_Ethernet6
...
---------- ------------------------ ---------------------- ---
Et1           s1-brdr2.atd.lab         Ethernet1           120
Et2           s1-spine1.atd.lab        Ethernet7           120
Et3           s1-spine2.atd.lab        Ethernet7           120
Et4           s1-core1.atd.lab         Ethernet2           120
Et6           s1-brdr2.atd.lab         Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: s1-brdr1 (cEOSLab, EOS-4.33.0F-39050855.4330F (engineering build))
!
no aaa root
!
...
Arista cEOSLab
Hardware version: 
Serial number: s1-brdr1
Hardware MAC address: 001c.73c0.c100
System MAC address: 001c.73c0.c100
