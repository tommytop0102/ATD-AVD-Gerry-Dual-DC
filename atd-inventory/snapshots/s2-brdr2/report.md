...
Et1                            up             up                 MLAG_PEER_s2-brdr1_Ethernet1
Et2                            up             up                 P2P_LINK_TO_S2-SPINE1_Ethernet8
Et3                            up             up                 P2P_LINK_TO_S2-SPINE2_Ethernet8
Et4                            down           down               
Et5                            up             up                 P2P_LINK_TO_s2-core2_Ethernet3
Et6                            up             up                 MLAG_PEER_s2-brdr1_Ethernet6
Lo0                            up             up                 EVPN_Overlay_Peering
Lo1                            up             up                 VTEP_VXLAN_Tunnel_Source
Lo100                          up             up                 bluevrf_VTEP_DIAGNOSTICS
Ma0                            up             up                 oob_management
Po1                            up             up                 MLAG_PEER_s2-brdr1_Po1
...
--------------- -------------------- ---------- ------------ ---------- -------
Ethernet2       172.32.255.29/31     up         up              1500           
Ethernet3       172.32.255.31/31     up         up              1500           
Ethernet5       172.16.30.6/31       up         up              1500           
Loopback0       192.2.255.10/32      up         up             65535           
Loopback1       192.2.254.9/32       up         up             65535           
Loopback100     10.255.1.10/32       up         up             65535           
Management0     192.168.0.201/24     up         up              1500           
Vlan110         10.1.10.1/24         up         up              1500           
Vlan1199        unassigned           up         up              9164           
Vlan3009        10.222.251.13/31     up         up              1500           
Vlan4093        10.222.251.13/31     up         up              1500           
Vlan4094        10.222.252.13/31     up         up              1500
```
## show lldp neighbors

```
Last table change time   : 2:46:52 ago
...
---------- ------------------------ ---------------------- ---
Et1           s2-brdr1.atd.lab         Ethernet1           120
Et2           s2-spine1.atd.lab        Ethernet8           120
Et3           s2-spine2.atd.lab        Ethernet8           120
Et5           s2-core2.atd.lab         Ethernet3           120
Et6           s2-brdr1.atd.lab         Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: s2-brdr2 (cEOSLab, EOS-4.33.0F-39050855.4330F (engineering build))
!
no aaa root
!
...
Arista cEOSLab
Hardware version: 
Serial number: s2-brdr2
Hardware MAC address: 001c.73c0.c201
System MAC address: 001c.73c0.c201
